<div id="layoutSidenav_content">
        ...
        <hr>
        <br>
        <form method="post" action="<?php echo base_url('data_logbok/ProsesEditDataloogbok'); ?>" enctype="multipart/form-data">
        ...
        <input type="hidden" name="id_loogbok" value= "<?php echo $loogbok['id_loogbok']; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-7">
                    <input type="time" class="form-control" name="waktu_mulai" required="" value="<?php echo $loogbok['waktu_mulai']; ?>">
                </div>
            </div>
            <div class="row mb-3">
                <label for="waktu_selesai" class="col-sm-2 col-form-label">Waktu Selesai</label>
                <div class="col-sm-7">
                    <input type="time" class="form-control" name="waktu_selesai" required="" value="<?php echo $loogbok['waktu_selesai']; ?>">
                </div>
            </div>
            <div class="row mb-3">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-7">
                    <div class="input-group">
                      <input type="text" class="form-control" name="km_awal" value="<?php echo $loogbok['km_awal']; ?>">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-7">
                    <div class="input-group">
                        <input type="text" class="form-control" name="km_akhir" value="<?php echo $loogbok['km_akhir']; ?>">
                        <span class="input-group-text">KM</span>
                    </div>
                </div>
            </div>
